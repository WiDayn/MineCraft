...
void Chunk::generate()
{
	...
	cubeList[XYZ(2, 2, 1)] = 1;
	cubeList[XYZ(2, 2, 2)] = 1;
	cubeList[XYZ(2, 2, 3)] = 1;
	cubeList[XYZ(2, 1, 1)] = 1;
	cubeList[XYZ(2, 1, 2)] = 1;
	cubeList[XYZ(2, 1, 3)] = 1;
	cubeList[XYZ(2, 3, 1)] = 1;
	cubeList[XYZ(2, 3, 2)] = 1;
	cubeList[XYZ(2, 3, 3)] = 1;
}
